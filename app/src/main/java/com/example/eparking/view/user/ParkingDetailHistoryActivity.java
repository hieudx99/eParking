...
public class ParkingDetailHistoryActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.parking_detail_history_activity);

        toolbar_back_icon = findViewById(R.id.toolbar_back_icon);
        toolbar_title = findViewById(R.id.toolbar_title);

        txtBillID = findViewById(R.id.txt_parking_detail_history_bill_id);
        txtLicensePlate = findViewById(R.id.txt_parking_detail_history_license_plate);
        txtParkingTime = findViewById(R.id.txt_parking_detail_history_parking_time);
        txtStartTime = findViewById(R.id.txt_parking_detail_history_start_time);
        txtEndTime = findViewById(R.id.txt_parking_detail_history_end_time);
        txtParkingSlot = findViewById(R.id.txt_parking_detail_history_parking_slot);
        txtUnitPrice = findViewById(R.id.txt_parking_detail_history_unit_price);
        txtTotal = findViewById(R.id.txt_parking_detail_history_total);
        txtPaymentMethod = findViewById(R.id.txt_parking_detail_history_payment_method);
        btnFinish = findViewById(R.id.btn_parking_detail_history_finish);
